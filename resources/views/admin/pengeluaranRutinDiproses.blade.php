          ...
          <table id="table_id" class="table table-bordered table-striped table-anggota">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td><a href="{{ route('backend.sumbangan.detail.via.ketua', $item->id) }}" class="">{{ $item->uraian_pengeluaran }}</a></td>
                      @elseif(auth()->user()->level=='spi')
                      <td><a href="{{ route('backend.sumbangan.detail.via.spi', $item->id) }}" class="">{{ $item->uraian_pengeluaran }}</a></td>
                      @endif
                      <td>{{ $item->volume }}</td>
                      <td>{{ $item->satuan }}</td>
