      ...
      <div class="card-body">
          <table id="table_id" class="table table-bordered table-striped table-anggota">
              <thead>
                  <tr>
                      <th width="0.1%">NO</th>
                      <th width="0.1%">Tanggal</th>
                      <th width="1%">Nama</th>
                      <th width="0.1%">Jumlah Iuran</th>
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          <a href="{{ route('backend.post.iuran.diverifikasi.bendahara.via.form', $item->id) }}" class="btn btn-success btn-sm">Verifikasi</a>
