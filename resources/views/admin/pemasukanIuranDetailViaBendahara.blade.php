  ...
  <div class="container-fluid" id="container-wrapper">
      <div class="mb-4 d-sm-flex align-items-center justify-content-between">
          <h1 class="mb-0 text-gray-800 h3"><a href="{{ route('backend.iuran.baru') }}" class="fas fa-arrow-circle-left text-danger"></a> {{ $menu }}</h1>
          <ol class="breadcrumb">
                  ...
                  <form method="post" action="{{ route('backend.post.iuran.diverifikasi.bendahara', $item->id) }}" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          <div class="row">
                              <div class="col-md-12">
                                  Jenis Setoran:
                                  <input id="jenis_pendapatan" readonly type="text" name="jenis_pendapatan" class="form-control @error('jenis_pendapatan') is-invalid @enderror" value="{{ old('jenis_pendapatan', $pemasukanIuran->jenis_pendapatan) }}">
                              </div>
                          </div>
                      </div>
