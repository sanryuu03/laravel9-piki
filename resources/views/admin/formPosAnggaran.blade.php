  ...
  <div class="card mx-3 my-3">
      <div class="card-body">
          <div class="container-fluid">
              <form method="post" action="{{ route('backend.save.form.pos.anggaran') }}" enctype="multipart/form-data">
                  {{ csrf_field() }}

                  <div class="form-group">
                      <label>Pos Anggaran</label>
                      <input type="hidden" name="id" class="form-control" value="{{ $posAnggaran->id }}">
                      <input type="text" name="nama_pos_anggaran" class="form-control @error('nama_pos_anggaran') is-invalid @enderror" value="{{ old('nama_pos_anggaran', $posAnggaran->nama_pos_anggaran) }}">
