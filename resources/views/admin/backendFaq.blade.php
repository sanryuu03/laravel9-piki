  ...
  <div class="container-fluid" id="container-wrapper">
      ...
      <div class="mb-3 row">
          <div class="container-fluid" id="container-wrapper">
              <div class="mb-4 d-sm-flex align-items-center justify-content-between">
                  <a href="{{ route('faq.create') }}" class="btn btn-info btn-sm">{{ ucwords('tambah faq') }}</a>
              </div>
          </div>
          <!-- Area Chart -->
          {{-- <div class="col">
  ...
  .<div class="container-fluid">
      <div class="card-body table-responsive">
          <table class="table table-bordered table-striped">
              <thead>
                  <tr>
                      <th width="0.01%">{{ ucwords('no') }}</th>
                      <th width="1px">{{ ucwords('pertanyaan') }}</th>
                      <th width="1px">{{ ucwords('jawaban') }}</th>
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          <a href="{{ route('faq.edit', $item->id) }}" class="btn btn-warning btn-sm"><i class="fa-solid fa-pencil"></i></a>
