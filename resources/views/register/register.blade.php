              ...
              <div class="col-md-6 mx-auto">
                ...
                <form action="{{ route('register.action') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="username" placeholder="Username Untuk Login"
                      value="{{ old('username') }}" />
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="birthplace" placeholder="Tempat Lahir Sesuai KTP"
                  ...
                  <div id="university" class="mb-3 d-none">
                    ...
                    <input class="form-control" type="text" name="university"
                      placeholder="Masukkan Nama Kampus Anda" value="{{ old('university') }}" />
                  </div>
                  <div id="fakultas" class="mb-3 d-none">
                    ...
                    <input class="form-control" type="text" name="fakultas"
                      placeholder="Masukkan Nama Fakultas Anda" value="{{ old('fakultas') }}" />
                  </div>
                  <div id="jurusan" class="mb-3 d-none">
                    <label>Jurusan <span class="text-danger">*</span></label>
                    <input class="form-control" type="text" name="jurusan"
                      placeholder="Masukkan Nama  Jurusan Anda" value="{{ old('jurusan') }}" />
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control" type="file" name="photo_ktp"
                      placeholder="Masukkan Photo KTP Anda" />
                  </div>
                  <div class="mb-3">
                    ...
                    <input class="form-control" type="file" name="photo_profile"
                      placeholder="Masukkan Photo Profile Anda" />
                  </div>
                  <div class="mb-3">
                    <label>Jemaat Gereja <span class="text-danger">*</span></label>
                    <input class="form-control" type="text" name="church"
                      placeholder="Masukkan Nama Gereja Anda" value="{{ old('church') }}" />
                  </div>
                  <div class="mb-3">
                    <label>Bidang Usaha (Optional)</label>
                    <input class="form-control" type="text" name="business_fields"
                      placeholder="Masukkan Bidang Usaha Anda" value="{{ old('business_fields') }}" />
                  </div>
                  <div class="mb-3">
                    <label>Deskripsi Keahlian (Optional)</label>
                    <input class="form-control" type="text" name="description_of_skills"
                      placeholder="Masukkan Kehalihan Anda" value="{{ old('description_of_skills') }}" />
                  </div>
                  <div class="mb-3">
                    <label>Password <span class="text-danger">*</span></label>
                    <input class="form-control" type="password" name="password"
                      placeholder="Isi Kata Sandi Minimal 5 Huruf" />
                  </div>
                  <div class="mb-3">
                    <label>Password Confirmation<span class="text-danger">*</span></label>
                    <input class="form-control" type="password" name="password_confirm"
                      placeholder="Pastikan Kata Sandi Sama Dengan diatas" />
                  </div>
                  <div class="mb-3">
